...
from gllib.shaders import gouradShader,toonShader,halfhalfShader,predominantColorShader,inverseShading,tvShader
...
mainGl3.activeShader = gouradShader
mainGl3.loadObjModel('./models/obj/R2.obj',translate=(0.2,-0.3,-1),scale=(2/125,2/125,2/125),rotation=(0,-45,0))
...
mainGl3.loadObjModel('./models/obj/tv2.obj',translate=(0,0,-1),scale=(1/200,1/200,1/200),rotation=(0,30,0))


mainGl3.glFinish('./tests/project1/projectTV.bmp')
